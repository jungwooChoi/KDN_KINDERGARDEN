...
public class PageBeanGallery implements Serializable {
	/**
	 * key : 검색 조건
	 * word: 검색 단어
	...
	public PageBeanGallery(){
		setKey("all");
		setWord("");
		setPagelink("1");
		setPageNo(1);
	}
	public PageBeanGallery(String key, String word, String pagelink, int pageNo) {
		setKey(key);
		setWord(word);
		setPagelink(pagelink);
		setPageNo(pageNo);
	}
	public PageBeanGallery(String key, String word, String pagelink, String pageNo) {
		setKey(key);
		setWord(word);
		setPagelink(pagelink);
		setPageNo(pageNo);
